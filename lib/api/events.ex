defmodule ExConduit.API.Events do
  ...
  @typedoc """
  Options for [`Events.get/1`](#get/1).
  ...
  """
  @type event :: ExConduit.Request.t()

  @doc """
  Generates a GET `%ExConduit.Request{}` for the LeadConduit /events API endpoint
  """
  @spec get(Keyword.t()) :: event()
  def get(opts \\ []) do
    ...
    %ExConduit.Request{
      ...
      opts_schema: %{
        ...
        before_id: {:query, :optional},
        start: {:query, :optional},
        end: {:query, :optional},
        type: {:query, :optional},
        lead_id: {:query, :optional},
        reference: {:query, :optional},
        flow_id: {:query, :optional},
        source_id: {:query, :optional},
        recipient_id: {:query, :optional},
        outcome: {:query, :optional},
